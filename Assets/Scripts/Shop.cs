...
public class Shop : MonoBehaviour
{
    ...
    {
        string[] translates1 = new string[] { "Выбрано", "Active", "Activado", "Attivato", "Medizinisch", "Активований" };
        string[] translates2 = new string[] { "Выбрать", "Choose", "Elegir", "Selezionare", "Wählen", "Вибрати", };
